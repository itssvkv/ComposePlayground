...
fun CustomUiComponent(
    ...
    backgroundIndicatorColor: Color = MaterialTheme.colorScheme.onSurface.copy(alpha = .1f),
    ...
    smallTextColor: Color = MaterialTheme.colorScheme.onSurface.copy(alpha = .3f)
) {
